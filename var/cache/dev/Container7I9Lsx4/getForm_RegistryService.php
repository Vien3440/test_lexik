...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\GroupeType' => function () {
    return ($this->privates['App\Form\GroupeType'] ?? $this->privates['App\Form\GroupeType'] = new \App\Form\GroupeType());
