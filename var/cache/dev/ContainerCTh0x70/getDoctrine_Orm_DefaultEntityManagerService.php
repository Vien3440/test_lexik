...
$a->setNamespace('sf_orm_default_074c2b28606c737d201be0ecf514e2d50d89314ed30730694a2cb09571a5b485');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_074c2b28606c737d201be0ecf514e2d50d89314ed30730694a2cb09571a5b485');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_074c2b28606c737d201be0ecf514e2d50d89314ed30730694a2cb09571a5b485');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\GroupeRepository' => function () {
    return ($this->privates['App\Repository\GroupeRepository'] ?? $this->load(__DIR__.'/getGroupeRepositoryService.php'));
